...
export const Appoinmentheader = () => {
    return (
        <div style={{ backgroundColor: 'grey', display: 'flex', flexDirection: 'row' }}>
            <div style={{ backgroundColor: 'pink', height: window.innerHeight, width: window.innerWidth * 0.2 }}>
side
            </div>
            <div style={{ backgroundColor: 'blue', height: window.innerHeight, width: window.innerWidth * 0.8,overflowY:"auto" }}>
                < div className='d-flex justify-content-end align-items-center gap-3' style={{ padding: "20px" }}><img src='https://media.istockphoto.com/id/155099359/photo/stethoscope-on-book.webp?a=1&b=1&s=612x612&w=0&k=20&c=odiw1GE1k6lNfKeh1FD65qJCtBTyNdShYmlfG3ST_40=' style={{ height: "75px", width: "75px", borderRadius: "50%" }} />
                    <div style={{ color: "white", backgroundColor: "blueviolet", justifyContent: "end", borderRadius: "10px", padding: "5px", fontSize: "", fontFamily: "poppins" }}>
                        <p>Username :-</p>
                        <p>Role :-</p>
                        <p>MobileNumber :-</p>
                    </div>
                ...
                <div className='d-flex justify-content-between align-items-center gap-3 ' style={{ padding: "20px" }}>
                    <div style={{ height: "150px", width: "2000px", color: "white", backgroundColor: "black", borderRadius: "10px", padding: "5px", fontSize: "18px", fontFamily: "poppins", textAlign: "center", alignItems: "center" }}>
